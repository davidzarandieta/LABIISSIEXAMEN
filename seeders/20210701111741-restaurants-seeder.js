    ...
    */
    ...
    await queryInterface.bulkInsert('Restaurants',
      [
        ...
        { name: '1 producto', description: '1 producto', address: 'Av. de la Reina Mercedes, 43, Sevilla', postalCode: '41012', logo: '', heroImage: '', url: 'http://1000productos.com/', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'attcliente@gruporestalia.com', phone: '+34902197494', createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'online',promocional: false  }
      ], {})
  },
